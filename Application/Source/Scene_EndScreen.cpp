...
Scene_EndScreen::Scene_EndScreen()
{
...
void Scene_EndScreen::RenderSkybox()
{
...
void Scene_EndScreen::RenderText(Mesh* mesh, std::string text, Color color)
{
...
void Scene_EndScreen::RenderTextOnScreen(Mesh* mesh, std::string text, Color color, float size, float x, float y)
{
	if (!mesh || mesh->textureID <= 0) //Proper error check
		return;
	glDisable(GL_DEPTH_TEST); //uncomment for RenderTextOnScreen
...
void Scene_EndScreen::RenderMeshOnScreen(Mesh* mesh, int x, int y, int sizex, int sizey)
{
...
void Scene_EndScreen::Render()
{
	...
	////No transform needed
	RenderTextOnScreen(meshList[GEO_TEXT], "Game Over", Color(0, 1, 0), 4, 20, 30);
	//if win == true
	RenderTextOnScreen(meshList[GEO_TEXT], "You Win", Color(0, 1, 0), 4, 25, 25);

	/*
	//if lose == true
	RenderTextOnScreen(meshList[GEO_TEXT], "You Lose", Color(0, 1, 0), 4, 22, 25);
	*/
